...
function HomeBody(){
    return (
     ...
     <div classname="home" >
      ...
      <div class="carousel-item__details">
        <h4 class="carousel-item__details--title"><Link to="/happyday">Happiest</Link></h4>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-item__details">
        <h4 class="carousel-item__details--title"><Link to="/happyday">Good Good</Link></h4>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-item__details">
        <h4 class="carousel-item__details--title"><Link to="/happyday">Just Survived</Link></h4>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-item__details">
        <h4 class="carousel-item__details--title"><Link to="/shittyday">ugh..Awful</Link></h4>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-item__details">
        <h4 class="carousel-item__details--title"><Link to="/shittyday">Not Good</Link></h4>
    ...
    <img class="carousel-item__img" src="https://img.freepik.com/premium-vector/beaming-face-emoji-with-crying-emoticon-big-smile-3d_163786-492.jpg?size=338&ext=jpg" alt="worst" />
      <div class="carousel-item__details">
        <h4 class="carousel-item__details--title"><Link to="/shittyday">must forgot</Link></h4>
